...
<html lang="en">
  <head>
    ...
    <!-- Font Awesome-->
    @includeIf('layouts.compact-layout.partials.css')
  </head>
  <body>
    <!-- Loader starts-->
    ...
    <div class="page-wrapper compact-wrapper compact-sidebar" id="pageWrapper">
      <!-- Page Header Start-->
      @includeIf('layouts.compact-layout.partials.header')
      <!-- Page Header Ends -->
      <!-- Page Body Start-->
      <div class="page-body-wrapper sidebar-icon">
        <!-- Page Sidebar Start-->
        @includeIf('layouts.compact-layout.partials.sidebar')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
    ...
    @includeIf('layouts.compact-layout.partials.js')
